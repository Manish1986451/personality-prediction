...
y_pred = clf.predict(maintestarray)
...
#import pickle
#pd.to_pickle(clf, r'C:\Users\MANISH\PycharmProjects\personalityTY\SVM\svm.pickle')
clf = pd.read_pickle(r'C:\Users\MANISH\PycharmProjects\personalityTY\SVM\svm.pickle')
